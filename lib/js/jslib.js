          ...
          if (obj[i].func) {
            ...
            obj[i].key = _lookupMobileKey(state, obj[i].key)
              ...
              if (dt["type"] == "timestamp") {
                  obj[i]["_dateTime"]["value"] = new Date(dt["value"]);
              }
          }
        }
      }
...
function dateToInt(dt) {
  ...
  return Math.floor(dt["_dateTime"]["value"].getTime() / 1000);
}

function intToDate(dt) {
}
...
function shiftOffset(date, offset) {
    ...
    /*
  const localOffset =
  return new Date(date.getTime() + (offset * 60))
  */
}

function dateYear(dt, offset) {
}

function dateMonth(dt, offset) {
}

function dateDay(dt, offset) {
}

function dateHour(dt, offset) {
}

function dateMinute(dt) {
}

function dateSecond(dt) {
}
