...
const LINKS = new (function() {
  ...
  function resolveServerValue (state, root) {
    ...
    function pushTraverse(obj) {
      const entry = { cmd: "TRAVERSE", obj: obj };
      stack.push(entry)
    }

    function pushResolve(obj, i) {
      const entry = { cmd: "RESOLVE", obj: obj, index: i };
      stack.push(entry)
    }
      ...
      if (cmd.cmd == "TRAVERSE") {
        ...
        if (obj instanceof Object) {
          ...
          for (let i in obj) {
            ...
            // Push child object
            pushTraverse(obj[i]);
            // Push request to resolve, once all children are resolved
            pushResolve(obj, i);
          }
        }
      } else if (cmd.cmd == "RESOLVE") {
        // Resolve this object
        const obj = cmd.obj;
        const i = cmd.index;
        ...
        throw new Error("Bad command: " + cmd.cmd);
      }
    }
  }
