...
class map :
  object ('self)
    ...
    method datetime        : Utility.CalendarShow.t -> Utility.CalendarShow.t
...
class fold :
  object ('self)
    ...
    method datetime        : Utility.CalendarShow.t -> 'self
...
object ('self)
  ...
  method datetime        : Utility.CalendarShow.t -> 'self * Utility.CalendarShow.t
